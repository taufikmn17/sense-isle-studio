...
export default function Hero() {
  return (
    <header className="relative flex-1 flex flex-col items-center justify-center text-center px-4 md:px-8 py-24 md:py-36 w-full">
      {/* Background Image */}
      ...
      <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center gap-6">
        <h1 className="text-3xl sm:text-5xl md:text-6xl font-light tracking-[0.25em] uppercase text-white drop-shadow-lg">
